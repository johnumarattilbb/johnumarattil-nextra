# BeVigil  <span style={{ fontWeight: 'normal' }}>--- search engine for mobile apps security information</span>
...
| Team           | Security Professionals (for research and feedback), Development Team, UX Designers |
| Duration       | 4 months |
...
Drawing from the insights gained during the research phase, our team began ideating on the user interface and experience design for Bevigil's app security search engine based on existing web design system in Figma. We aimed to create a user-centric platform that seamlessly integrated powerful app search capabilities with insightful security information. Here are the key features and design considerations we incorporated:
