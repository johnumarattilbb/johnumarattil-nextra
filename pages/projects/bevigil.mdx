...
At CloudSEK, we started on a mission to empower the community with insights into mobile application security, leveraging the our repository of scan data of a million publicly available apps on the Play Store. Our aim was to facilitate a seamless experience for security professionals, enabling them to effortlessly search and retrieve pertinent information on app security. This case study chronicles our design journey, from initial research and ideation to the development of the final product.
...
Drawing from the insights gained during the research phase, our team began ideating on the user interface and experience design for Bevigil's app security search engine. We aimed to create a user-centric platform that seamlessly integrated powerful app search capabilities with insightful security information. Here are the key features and design considerations we incorporated:
