# XVigil  <span style={{ fontWeight: 'normal' }}>--- redesigning AI Powered Real-time Threat Monitoring System</span>

| My role        | Sr UX Designer |
|----------------|----------------|
| Responsibilities | <ul><li>Engaging with the PMs, Customer Team, and users for gathering requirements and feedback</li><li>Developing a detailed Design Product Requirement Document (PRD) based on collected requirements</li><li>Designing and refining a comprehensive site map and user flows to improve navigation</li><li>Creating a cohesive and scalable design system in Figma creating components, layouts, and copywriting for consistency and usability</li><li>Prototyping and testing solutions with internal employees to refine and finalize UI features and interactions</li></ul> |
